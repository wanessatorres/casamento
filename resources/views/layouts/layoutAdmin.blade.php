...
<head>
    ...
    <link href="{{URL::asset('css/admin/bootstrap-reset.css')}}" rel="stylesheet">
    <link href="{{URL::asset('font-awesome/css/font-awesome.css')}}" rel="stylesheet">
    <link href="{{URL::asset('js/jvector-map/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet">
    <link href="{{URL::asset('css/admin/clndr.css')}}" rel="stylesheet">
    <link href="{{URL::asset('css/admin/style.css')}}" rel="stylesheet">
   	<link href="{{URL::asset('css/admin/style-responsive.css')}}" rel="stylesheet">
...
<!--Core js-->
    ...
    <script src = "{{URL::asset('bs3/js/bootstrap.min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jquery.dcjqaccordion.2.7.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jquery.scrollTo.min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jQuery-slimScroll-1.3.0/jquery.slimscroll.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jquery.nicescroll.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/skycons/skycons.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jquery.scrollTo/jquery.scrollTo.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('//cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/calendar/clndr.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/calendar/moment-2.2.1.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/evnt.calendar.init.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jvector-map/jquery-jvectormap-1.2.2.min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jvector-map/jquery-jvectormap-us-lcc-en.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/gauge/gauge.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/css3clock/js/css3clock.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/easypiechart/jquery.easypiechart.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/sparkline/jquery.sparkline.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/morris-chart/morris.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/morris-chart/raphael-min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/flot-chart/jquery.flot.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/flot-chart/jquery.flot.tooltip.min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/flot-chart/jquery.flot.pie.resize.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/flot-chart/jquery.flot.animator.min.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/flot-chart/jquery.flot.growraf.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/dashboard.js')}}" type = "text/javascript"></script>
    <script src = "{{URL::asset('js/jquery.customSelect.min.js')}}" type = "text/javascript"></script>
